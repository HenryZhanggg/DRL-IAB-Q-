...
class Agent:
    def __init__(self, state_dim, action_dim, learning_rate=0.001, gamma=0.99, epsilon_start=1.0, epsilon_end=0.01, epsilon_decay=80000):
...
class NetworkDeploymentEnv(gym.Env):
    def __init__(self):
        ...
        self.observation_space = spaces.Dict({
            ...
            "N": spaces.Box(low=0, high=8, shape=(self.n_potential_nodes,))
        })
        self.overhead = 1.2
